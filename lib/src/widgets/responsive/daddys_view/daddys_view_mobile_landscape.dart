...
class DaddysViewMobileLandscape extends StatefulWidget {
  const DaddysViewMobileLandscape({super.key});

  @override
  State<DaddysViewMobileLandscape> createState() => _DaddysViewMobileLandscapeState();
}

class _DaddysViewMobileLandscapeState extends State<DaddysViewMobileLandscape> {
